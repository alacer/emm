...
#ifndef BEJWRMSO2YY_1KTM_1MKZYPSCZJAAAZTAYS_H_
#define BEJWRMSO2YY_1KTM_1MKZYPSCZJAAAZTAYS_H_
...
#define SELF BeJwrMSo2yy_1KTM_1MKzYpSCzJAAAzTAYs
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), origin_(ot.origin_), path_(ot.path_) 
      { constructPayload(ot); }
    SELF(const origin_type & _origin, const path_type & _path) : Tuple(), origin_(_origin), path_(_path) { }
...
#undef SELF
#endif // BEJWRMSO2YY_1KTM_1MKZYPSCZJAAAZTAYS_H_ 
