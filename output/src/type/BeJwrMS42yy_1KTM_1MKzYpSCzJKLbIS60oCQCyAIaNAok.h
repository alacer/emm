// t3s6origins4paths8nextPath


#ifndef BEJWRMS42YY_1KTM_1MKZYPSCZJKLBIS60OCQCYAIANAOK_H_
#define BEJWRMS42YY_1KTM_1MKZYPSCZJKLBIS60OCQCYAIANAOK_H_
...
#define SELF BeJwrMS42yy_1KTM_1MKzYpSCzJKLbIS60oCQCyAIaNAok
...
public:
    ...
    typedef SPL::rstring nextPath_type;

    enum { num_attributes = 3 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), origin_(ot.origin_), path_(ot.path_), nextPath_(ot.nextPath_) 
      { constructPayload(ot); }
    SELF(const origin_type & _origin, const path_type & _path, const nextPath_type & _nextPath) : Tuple(), origin_(_origin), path_(_path), nextPath_(_nextPath) { }
    ...
    nextPath_type & get_nextPath() { return nextPath_; }
    const nextPath_type & get_nextPath() const { return nextPath_; }
    void set_nextPath(const nextPath_type & _nextPath) { nextPath_ = _nextPath; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<nextPath_type >()(nextPath_);
        return s;
    }
   ...
   size += nextPath_.getSerializedSize();
    ...
    { 
        ...
        std::swap(nextPath_, ot.nextPath_);
...
#undef SELF
#endif // BEJWRMS42YY_1KTM_1MKZYPSCZJKLBIS60OCQCYAIANAOK_H_ 
