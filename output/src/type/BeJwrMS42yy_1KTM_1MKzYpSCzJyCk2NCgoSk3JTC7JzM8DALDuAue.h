// t3s6origins4pathls10prediction


#ifndef BEJWRMS42YY_1KTM_1MKZYPSCZJYCK2NCGOSK3JTC7JZM8DALDUAUE_H_
#define BEJWRMS42YY_1KTM_1MKZYPSCZJYCK2NCGOSK3JTC7JZM8DALDUAUE_H_
...
#define SELF BeJwrMS42yy_1KTM_1MKzYpSCzJyCk2NCgoSk3JTC7JzM8DALDuAue
...
public:
    ...
    typedef SPL::rstring path_type;
    typedef SPL::list<SPL::rstring > prediction_type;

    enum { num_attributes = 3 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), origin_(ot.origin_), path_(ot.path_), prediction_(ot.prediction_) 
      { constructPayload(ot); }
    SELF(const origin_type & _origin, const path_type & _path, const prediction_type & _prediction) : Tuple(), origin_(_origin), path_(_path), prediction_(_prediction) { }
    ...
    path_type & get_path() { return path_; }
    const path_type & get_path() const { return path_; }
    void set_path(const path_type & _path) { path_ = _path; }
    
    prediction_type & get_prediction() { return prediction_; }
    const prediction_type & get_prediction() const { return prediction_; }
    void set_prediction(const prediction_type & _prediction) { prediction_ = _prediction; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<path_type >()(path_);
        s = 37 * s + std::tr1::hash<prediction_type >()(prediction_);
        return s;
    }
   ...
   size += path_.getSerializedSize();
   size += prediction_.getSerializedSize();
    ...
    { 
        ...
        std::swap(path_, ot.path_);
        std::swap(prediction_, ot.prediction_);
...
#undef SELF
#endif // BEJWRMS42YY_1KTM_1MKZYPSCZJYCK2NCGOSK3JTC7JZM8DALDUAUE_H_ 
