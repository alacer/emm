...
#ifndef BEJWRMCO0YKXJMZRISY0QYCZJREOTAGBCMGCW_H_
#define BEJWRMCO0YKXJMZRISY0QYCZJREOTAGBCMGCW_H_
...
#define SELF BeJwrMco0ykxJMzRISy0qyczJrEotAgBCmgcW
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), id_(ot.id_), fertilizer_(ot.fertilizer_) 
      { constructPayload(ot); }
    SELF(const id_type & _id, const fertilizer_type & _fertilizer) : Tuple(), id_(_id), fertilizer_(_fertilizer) { }
    ...
    {
        size_t size = sizeof(SPL::int32)+sizeof(SPL::float32);
...
#undef SELF
#endif // BEJWRMCO0YKXJMZRISY0QYCZJREOTAGBCMGCW_H_ 
