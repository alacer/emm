...
-->
 ...
 <!-- START COMMON INTERMAL AND AUTHOR PACKAGE FILE PATH VARIABLES< ################################## --> 
  ...
  <xsl:variable name="web-site-owner">dwkorea@kr.ibm.com</xsl:variable>
    <!-- 5.4 1/29/06 fjc add  -->
...
<!-- 5.10 2/18 llk: remove reference to IBM Systems views; IBM Systems no longer valid content area -->
  ...
  <xsl:variable name="kp-unchecked-checkmark">회색은 체크되지 않은 곳입니다</xsl:variable>
  <xsl:variable name="kp-checked-checkmark">녹색 체크마크가 선택되었습니다.</xsl:variable>
