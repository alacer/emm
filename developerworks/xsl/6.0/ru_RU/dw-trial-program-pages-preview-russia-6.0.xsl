...
<!-- Overlays --> 
<!-- <#include "/inc/ru_RU/s-reserved-overlay-landing.ftl"> -->
  ...
  <xsl:choose>
    <xsl:when test=".//content-area-primary/@name = 'data' "> 
      <div id="ibm-navigation">
        <h2 class="ibm-access">Навигация по содержимому</h2>
        
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/ru/data/">Information
            Mgmt</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/data/newto/">для новичков</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/views/data/libraryview.jsp">Статьи</a></li>
          <li><a href="http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1445">Форумы</a></li>
        </ul>
      </div>
    </xsl:when>
    <xsl:when test=".//content-area-primary/@name = 'lotus' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/ru/lotus/">Lotus</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/lotus/newto/">для новичков</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/views/lotus/libraryview.jsp">Статьи</a></li>
          <li><a href="http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1448">Форумы</a></li>
        </ul>
      </div>
    </xsl:when>
    <xsl:when test=".//content-area-primary/@name = 'rational' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a
            href="http://www.ibm.com/developerworks/ru/rational/">Rational</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/rational/newto/">для новичков</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/views/rational/libraryview.jsp">Статьи</a></li>
          <li><a href="http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1455">Форумы</a></li>
        </ul>
      </div>
    </xsl:when>
    <xsl:when test=".//content-area-primary/@name = 'tivoli' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/ru/">developerWorks</a></li>
        </ul>
      </div>
    </xsl:when>
    <xsl:when test=".//content-area-primary/@name = 'websphere' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a
            href="http://www.ibm.com/developerworks/ru/websphere/">WebSphere</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/websphere/newto/">для новичков</a></li>
          <li><a href="http://www.ibm.com/developerworks/ru/views/websphere/libraryview.jsp">Статьи</a></li>
          <li><a href="http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1458">Форумы</a></li>
        </ul>
      </div>
    </xsl:when>
  </xsl:choose>
...
<!-- <#include "/inc/ru_RU/s-reserved-bottom-trial.ftl"> -->
<!-- <#include "/inc/ru_RU/s-reserved-bottom-scripts-trial.ftl"> -->
