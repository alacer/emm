...
<!-- 5.4 4/27  llk:  remove reference to server to avoid redirect to ibm.com -->
  ...
  <xsl:variable name="pdf-common">A4/Letter</xsl:variable>
  <!-- 6.0 Maverick beta jpp 06/18/08 END -->
<!-- 5.0 6/1 tdc:  Added pdf-related variables -->
<xsl:variable name="pdf-alt-letter">PDF - Letter</xsl:variable>
<xsl:variable name="pdf-alt-a4">PDF - A4</xsl:variable>
    <!-- 5.10 keb 03/07/08:  Added common size PDF alt text -->
  <xsl:variable name="pdf-alt-common">PDF - в размер A4 и Letter</xsl:variable>
...
<xsl:variable name="pdf-text-a4">PDF - A4</xsl:variable>
  ...
  <xsl:variable name="pdf-text-common">PDF - в размер A4 и Letter</xsl:variable>
...
<!-- 5.10 llk 02/04:  add social tagging as an include -->
  ...
  <xsl:variable name="drivers-downloads-url">
    ...
    <xsl:variable name="developerworks-top-url-pdf">ibm.com/developerWorks/ru/</xsl:variable>
	...
	<xsl:variable name="developerworks-top-heading">developerWorks Россия</xsl:variable>
 ...
 <xsl:variable name="events-url"></xsl:variable>   
  ...
  <xsl:variable name="ibmi-top-url">http://www.ibm.com/developerworks/systems/ibmi/</xsl:variable> 
   ...
   <xsl:variable name="mobile-top-url">http://www.ibm.com/developerworks/ru/mobile/</xsl:variable>
...
<!-- 5.5 7/5 llk: updated typo in April's text -->
  ...
  <xsl:variable name="contentarea-ui-name-downloads">Загрузить (EN)</xsl:variable>
	...
	<xsl:variable name="contentarea-ui-name-l">Linux</xsl:variable>
  	...
  	<xsl:variable name="contentarea-ui-name-mobile">Мобильные приложения</xsl:variable>
 ...
 <!-- 01/15/13 jmh: change variable value to Tivoli (service management)  -->
  ...
  <xsl:variable
      name="techlibview-mobile">http://www.ibm.com/developerworks/ru/views/mobile/libraryview.jsp</xsl:variable>
...
<!-- 5.10 2/18 llk: remove reference to IBM Systems views; IBM Systems no longer valid content area -->
  ...
  <xsl:variable name="techlibview-j">http://www.ibm.com/developerworks/ru/views/java/libraryview.jsp</xsl:variable>
	...
	<xsl:variable name="techlibview-wa">http://www.ibm.com/developerworks/ru/views/global/libraryview.jsp</xsl:variable>
	 <!-- 5.10 11/07 llk: remove workplace as a content area  dr 2558 -->
	<!-- 5.10 11/07 llk: remove wireless as a content area  dr 2558 -->
  ...
  <xsl:variable name="kp-unchecked-checkmark">Помечено как неисполненное - пометить как исполненное</xsl:variable>
  <xsl:variable name="kp-checked-checkmark">Помечено как исполненное - пометить как неисполненное</xsl:variable>
...
<!-- 5.6 12/12/06 egd Add delicious and delicious dw metrics scripts -->
  ...
  <!-- llk 12/13/2011 - added trademark url to localize pdf creation -->
    <xsl:variable name="pdfTrademarks-url">http://www.ibm.com/developerworks/ru/ibm/trademarks/</xsl:variable>
<xsl:variable name="pdfTrademarks-url-printed">www.ibm.com/developerworks/ru/ibm/trademarks/</xsl:variable>
