...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
 <xsl:output method="xml" indent="no" omit-xml-declaration="yes" encoding="UTF-8"/>
  ...
  <!-- Call main xsl file and locale-specific xsl files --> 
    ...
    <xsl:include href="dw-translated-text-ssa-6.0.xsl" />
  ...
  <xsl:include href="dw-landing-product-preview-ssa-6.0.xsl"/>
  <xsl:include href="dw-landing-generic-preview-ssa-6.0.xsl"/>
  <xsl:include href="dw-tutorial-preview-ssa-6.0.xsl"/>  
  <xsl:include href="dw-article-preview-ssa-6.0.xsl"/>
  <xsl:include href="dw-sidefile-preview-ssa-6.0.xsl"/>
  <xsl:include href="dw-landing-generic-pagegroup-preview-ssa-6.0.xsl"/>
  <xsl:include href="dw-trial-program-pages-preview-ssa-6.0.xsl"/>
   <xsl:include href="dw-knowledge-path-preview-ssa-6.0.xsl"/>
...
<xsl:include href="dw-summary-preview-ssa-6.0.xsl"/>
