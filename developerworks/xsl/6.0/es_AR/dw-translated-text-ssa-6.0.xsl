...
-->
  ...
  <!-- 12/13/2011 - llk - added top url for pdfs -->
    <xsl:variable name="developerworks-top-url-pdf">ibm.com/developerWorks/ssa/</xsl:variable>
  ...
  <xsl:variable name="developerworks-top-heading">developerWorks en español</xsl:variable>
...
<xsl:variable name="master5-author-alt">Nivel 5 de autor Master en developerWorks</xsl:variable> 
  ...
  <!-- 6.0 Maverick beta egd 06/12/08: Updated for MAVERICK to include zone top URLs -->
   ...
   <xsl:variable name="analytics-top-url">http://www.ibm.com/developerworks/ssa/analytics/</xsl:variable>
  ...
  <xsl:variable name="lotus-top-url">http://www.ibm.com/developerworks/ssa/</xsl:variable>
   ...
   <xsl:variable name="mobile-top-url">http://www.ibm.com/developerworks/ssa/mobile/</xsl:variable>
  ...
  <xsl:variable name="contentarea-ui-name-mobile">Desarrollo móvil</xsl:variable>
 ...
 <!-- 01/15/13 jmh: change variable value to Tivoli (service management)  -->
  ...
  <xsl:variable
      name="techlibview-mobile">http://www.ibm.com/developerworks/ssa/views/mobile/libraryview.jsp</xsl:variable>
  <!-- BA-Commerce-Security 04/26/12 jmh: add variable for analytics tech library view url -->
  <xsl:variable
      name="techlibview-analytics">http://www.ibm.com/developerworks/ssa/views/analytics/libraryview.jsp</xsl:variable>
 ...
 //-->
  ...
  <!-- llk 12/13/2011 - added trademark url to localize pdf creation -->
    <xsl:variable name="pdfTrademarks-url">http://www.ibm.com/developerworks/ssa/ibm/trademarks/</xsl:variable>
<xsl:variable name="pdfTrademarks-url-printed">www.ibm.com/developerworks/ssa/ibm/trademarks/</xsl:variable>
