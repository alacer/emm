...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="xsl fo">
  ...
  <xsl:variable name="ssi-s-backlink-module">
    ...
    <p class="ibm-ind-link ibm-back-to-top ibm-no-print">
      <a class="ibm-anchor-up-link" href="#ibm-pcon">Volver arriba</a> 
    </p>
  </xsl:variable>
...
<td align="right" valign="top">
<a class="fbox" href="#main"><strong>Volver arriba</strong></a>
</td>
</tr>
</table>
</td>
...
document.write('<tr valign="top"><td width="8"><img src="]]></xsl:text><xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img src="]]></xsl:text>
  <xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/v14/icons/em.gif" height="16" width="16" vspace="3" alt="Enviar esta página" /></td><td width="122"><p><a class="smallplainlink" href="javascript:document.email.submit()"><strong>Enviar esta página</strong></a></p></td></tr>');
//-->
</script>]]></xsl:text>
...
<td width="122" class="small"><p><span class="ast">Documento que requieren tener Javascript no serán mostradas.</span></p></td>
</tr>
</noscript>
</xsl:variable>
...
<xsl:text disable-output-escaping="yes"><![CDATA[<script language="JavaScript" type="text/javascript">
<!--
document.write('<tr valign="top"><td width="8"><img src="]]></xsl:text><xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img alt="Configurar la impresora en modo de paisaje" height="16" src="]]></xsl:text>
...
<meta name="DC.Language" scheme="rfc1766" content="es-AR" />
...
<tr>
<td class="left-nav-spacer"><a class="left-nav-overview" href="http://www.ibm.com/developerworks/ssa/">&nbsp;</a></td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr>
<td class="left-nav-overview" colspan="2"><a class="left-nav-overview" href="http://www.ibm.com/developerworks">developerWorks en español</a></td>
</tr>
</table>
</xsl:variable>
...
<tr>
<td colspan="2"><p>Por favor, completar este formulario para ayudarnos a servirle mejor.</p></td>
</tr>
<tr valign="top">
...
<p><label for="Goal">¿La información le ayudó a alcanzar su meta?</label></p>
</td>
...
<tr>
<td><input type="radio" name="goal" id="goal-yes" value="Yes" /><label for="goal-yes">Si</label></td>
<td><input type="radio" name="goal" id="goal-no" value="No" /><label for="goal-no">No</label></td>
<td><input type="radio" name="goal" id="goal-undecided" value="Don't know" /><label for="goal-undecided">No sé</label></td>
</tr>
</table>
</td>
</tr>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Comments">Por favor, sus comentarios nos ayuda a mejorar esta página:</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Rating">¿Qué tan útil es la información?</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr>
<td width="58" align="left"><span class="greytext">Nada</span><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><span class="greytext">útil</span></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="61" align="left"><span class="greytext">Sumamente<xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>útil</span></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
  <td colspan="2"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/ar/es/submit.gif" border="0" width="120" height="21" alt="Submit" /></td>
</tr>
<tr><td colspan="2"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
<tr>
<td colspan="3"><p>Por favor, completar este formulario para ayudarnos a servirle mejor.</p></td>
</tr>
<tr valign="top">
...
<tr>
<td width="60" align="left"><span class="greytext">Nada</span><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><span class="greytext">útil</span></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="63" align="left"><span class="greytext">Sumamente<xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>útil</span></td>
</tr></table>
</td>
<td width="100%">&nbsp;</td>
</tr>
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
  <td colspan="3"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/ar/es/submit.gif" border="0" width="120" height="21" alt="Submit" /></td>
</tr>
<tr><td colspan="3"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr><td class="v14-header-2-small">Evalúe está página</td></tr>
</table>
...
<td width="125"><p><a class="smallplainlink" href="#rate"><strong>Ayúdanos a mejorar este contenido</strong></a></p></td>
</tr>
</table>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr><td class="v14-header-2-small">Evalúe este tutorial</td></tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="v14-gray-table-border">
<tr>
<td width="150" class="no-padding">
...
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td>
<td><img src="{$newpath-ibm-local}www.ibm.com/i/v14/icons/d_bold.gif" height="16" width="16" border="0" vspace="3" alt=""/></td>
<td width="125"><p><a class="smallplainlink" href="rating.html"><strong>Ayúdanos a mejorar este contenido</strong></a></p></td>
</tr>
</table>
</td>
</tr>
