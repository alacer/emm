...
<!--  Overlays -->  
<!-- <#include "/inc/es_AR/s-reserved-overlay-landing.ftl"> -->
...
<xsl:comment> CONTENT_END </xsl:comment>
  ...
  <div id="ibm-navigation">
    ...
    <ul id="ibm-primary-links">
      <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/ssa/">developerWorks</a></li>
    </ul>
  </div>
...
<!-- <#include "/inc/es_AR/s-reserved-bottom-landing.ftl"> -->
<!-- <#include "/inc/es_AR/s-reserved-bottom-scripts-landing.ftl"> -->
