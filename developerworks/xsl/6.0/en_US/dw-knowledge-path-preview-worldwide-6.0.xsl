...
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCIBIZZ" />  
  </xsl:when>
...
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCCLDZZ" />
  </xsl:when>
<xsl:when test=".//content-area-primary/@name = 'industry' ">
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCINDZZ" />
  </xsl:when>  
<xsl:otherwise>
  </xsl:otherwise>
</xsl:choose>
        ...
        <div class="ibm-column  ibm-first kp-summary-column-first">
            <div class="ibm-no-print" id="dw-tag-content">
                ...
                class="kp-bar">|</span><xsl:apply-templates select="."><xsl:with-param name="template">skillLevel</xsl:with-param></xsl:apply-templates><span id="ratingUIBar"    
                    class="kp-bar">|</span><span id="ratingUI">[Rating code here]</span><span class="kp-bar">|</span><span id="interestShow" class="ibm-no-print"></span>
            </p>
            </div>
        </div>
    </div> 
...
<div class="kp-track">
   <p class="ibm-ind-link">
       <a class="ibm-password-link" href="#" onclick="showSignIn();return false;">  <strong>Sign in</strong></a> to save your progress <!-- 07/13/11 Removed checkmark per Ami -->     
      (<a class="kp-learn-text" href="#learnMore" onclick="ibmCommon.Overlays.show('learnMore', this);return false;">Learn more</a>)
   </p>
</div>
<!-- Alternate signed in -->
<!-- 
...
<div class="dw-kp-rate">
    <br />
    <br />
      <h2 class="kp-rate-head">Rate this content</h2><span id="interactiveRatingUI"></span>
    <br />
    <br />
</div>
...
<h2 class="kp-feedback-head">Give us feedback</h2>
...
<p><span class="kp-form-step-head"><strong>1.</strong>&nbsp;</span><strong>Are you finished with this knowledge
    path?</strong><br />
   <span class="ibm-input-group kp-form-entry">
      <input id="yes" name="tasks" type="radio" value="yes"/><label for="yes">Yes</label>&nbsp;&nbsp;&nbsp;
      <input id="no" name="tasks" type="radio" value="no"/><label for="yes">No</label>&nbsp;&nbsp;&nbsp;
    </span>
</p>
   
<p><span class="kp-form-step-head"><strong>2.</strong>&nbsp;</span><strong>How much did you learn?</strong><br />  
   <span class="ibm-input-group kp-form-entry">
      <input id="alot" name="learned" type="radio" value="alot" /><label for="alot">A lot</label>&nbsp;&nbsp;&nbsp;
      <input id="some" name="learned" type="radio" value="some" /><label for="some">Some</label>&nbsp;&nbsp;&nbsp;
      <input id="alittle" name="learned" type="radio" value="alittle" /><label for="alittle">A little</label>&nbsp;&nbsp;&nbsp;
      <input id="nothing" name="learned" type="radio" value="nothing" /><label for="nothing">Nothing</label>
</span>
</p>

<p class="dw-kp-form-tell-us"><span class="kp-form-step-head"><strong>3.</strong>&nbsp;</span><strong>Tell us more</strong>       
              <ul class="ibm-bullet-list ibm-no-links kp-form-entry kp-form-list">
                    ...
                    <li>What can we do better?</li>
                     ...
                     <span class="ibm-access"><label for="feedback">Enter your comments below</label></span>
<textarea name="kp-feedback" rows="7" cols="60" id="feedback" class="kp-form-textarea" >Comments are here.</textarea>
    
</p>
    
<p id="dw-kp-submit"><input class="ibm-btn-arrow-pri kp-form-submit" name="ibm-submit" value="Submit" type="submit" /></p>
...
<h2>About this knowledge path</h2>
