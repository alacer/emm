...
<!-- COMMENTED OUT EXTERNAL SEARCH <xsl:comment> RESERVED_HEADER_INCLUDE </xsl:comment>
...
<script language="javascript" src="/developerworks/js/ajax1.js" type="text/javascript"></script>
...
<p><strong>Summary:</strong>&nbsp; <xsl:apply-templates select=".">
...
<xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>Comments:</strong> &nbsp; <span id="nCmts"><img alt="" src="http://dw1.s81c.com/developerworks/i/circle-preloader.gif" height="12" width="50" /><img alt="" src="http://dw1.s81c.com/i/gif" height="14" width="1" /></span>
...
<script language="JavaScript" src="http://dw1.s81c.com/developerworks/js/insertcomment.js" type="text/javascript">//</script>
...
<p><a href="http://www.ibm.com/developerworks/ibm/trademarks/">Trademarks</a></p>
...
<!-- Removed TOC and Next steps because not used for summaries -->
