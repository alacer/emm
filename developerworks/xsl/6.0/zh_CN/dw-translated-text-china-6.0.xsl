...
<!-- 5.7 3/9 llk: update "skip to main menu text -->
  ...
  <xsl:variable name="pdf-common">A4 或信纸</xsl:variable>
...
<xsl:variable name="pdf-alt-common">PDF 格式 - 尺寸适合 A4 和信纸</xsl:variable>
<xsl:variable name="pdf-text-letter">PDF - 信纸</xsl:variable>
<xsl:variable name="pdf-text-a4">PDF - A4</xsl:variable>
  <!-- 5.10 keb 03/07/08:  Added common size PDF text -->
<xsl:variable name="pdf-text-common">PDF - 尺寸适合 A4 和信纸</xsl:variable>
<!-- 5.2 8/17/05 tdc:  Added pdf-page and pdf-pages -->
<xsl:variable name="pdf-page">页</xsl:variable>
<xsl:variable name="pdf-pages">页</xsl:variable>
...
<!-- 5.10 llk 02/04:  add social tagging as an include -->
  ...
  <xsl:variable name="ssi-s-backlink-rule">
    ...
    <xsl:variable name="download-get-adobe">
        <xsl:text disable-output-escaping="yes"><![CDATA[获得 Adobe&#174; Reader&#174;]]></xsl:text>
        </xsl:variable>
  ...
  <xsl:variable name="zoneleftnav-path">/inc/zh_CN/</xsl:variable>
    ...
    <xsl:variable name="developerworks-top-url-pdf">ibm.com/developerWorks/cn/</xsl:variable>
	...
	<xsl:variable name="developerworks-top-heading">developerWorks 中国</xsl:variable>
 ...
 <xsl:variable name="events-url">https://www.ibm.com/developerworks/community/groups/service/html/communityview?communityUuid=6d7f9e5d-5f89-4767-a006-a81b8d186370&amp;lang=zh</xsl:variable>   
  ...
  <!-- 6.0 Maverick beta egd 06/12/08: Updated for MAVERICK to include zone top URLs -->
   ...
   <xsl:variable name="agile-top-url">http://www.ibm.com/developerworks/cn/agile/</xsl:variable>
  ...
  <xsl:variable name="ibmi-top-url">http://www.ibm.com/developerworks/cn/ibmi/</xsl:variable> 
   ...
   <xsl:variable name="mobile-top-url">http://www.ibm.com/developerworks/cn/mobile/</xsl:variable>
...
<!-- 5.4 3/13 llk: update the English text to Chinese per China team request -->
 ...
 <xsl:variable name="inline-comments-heading">评论</xsl:variable>
  ...
  <xsl:variable name="contentarea-ui-name-agile">敏捷开发</xsl:variable>
...
<!-- 5.4 3/24 llk: add for AIX content area -->
  ...
  <xsl:variable name="contentarea-ui-name-downloads">Downloads</xsl:variable>
	...
	<xsl:variable name="contentarea-ui-name-l">Linux</xsl:variable>
  	...
  	<xsl:variable name="contentarea-ui-name-mobile">移动开发</xsl:variable>
...
<xsl:variable name="contentarea-ui-name-pa">Multicore acceleration</xsl:variable>
  ...
  <xsl:variable name="techlibview-agile">http://http://www.ibm.com/developerworks/cn/views/agile/libraryview.jsp</xsl:variable>
  <!-- Mobile & Agile 02/28/12 jmh: add variable for mobile tech library view url -->
  <xsl:variable name="techlibview-mobile">http://www.ibm.com/developerworks/cn/views/mobile/libraryview.jsp</xsl:variable>
...
<!-- 5.10 2/18 llk: remove reference to IBM Systems views; IBM Systems no longer valid content area -->
	  ...
	  <!-- BA-Commerce-Security 04/26/12 jmh: leaving existing value in place for cn security tech library view url -->
...
<!-- 5.10 11/07 llk: remove workplace as a content area  dr 2558 -->
  ...
  <xsl:variable name="kp-unchecked-checkmark">项目未被标记 - 点击标记为完成</xsl:variable>
  <xsl:variable name="kp-checked-checkmark">项目已被标记为完成 - 点击取消标记</xsl:variable>
...
<xsl:variable name="latest-content-heading">最新内容</xsl:variable>
  ...
  <xsl:variable name="pdfSection">段落</xsl:variable>
  <xsl:variable name="pdfSkillLevel">级别</xsl:variable>
  ...
  <!-- 5.11 12/03/08 egd:  removed the 1994, text until early Jan when we rewrite this -->
   ...
   exists-->
    <xsl:variable name="dcRights-v16"><xsl:text>&#169; 版权所有&#160;</xsl:text>
 	 <xsl:text>IBM 公司&#160;</xsl:text>
  ...
  <xsl:variable name="pdfTrademarks">商标</xsl:variable>
  <!-- llk 12/13/2011 - added trademark url to localize pdf creation -->
    <xsl:variable name="pdfTrademarks-url">http://www.ibm.com/developerworks/cn/ibm/trademarks/</xsl:variable>
<xsl:variable name="pdfTrademarks-url-printed">www.ibm.com/developerworks/cn/ibm/trademarks/</xsl:variable>
  <!-- 5.2 8/31 fjc:  Added for tutorial PDFs -->
  <xsl:variable name="pdfResource-list-forum-text">参与与本文档相关的论坛讨论。</xsl:variable>
...
<xsl:variable name="dw-gizmo-alt-text">Add content to your personalized page</xsl:variable>
  ...
  <xsl:variable name="codeTableSummaryAttribute">这一表格包含代码清单。</xsl:variable>
  <xsl:variable name="downloadTableSummaryAttribute">这一表格包含本文档的下载资源。</xsl:variable>
  <xsl:variable name="errorTableSummaryAttribute">这一表格包含错误消息。</xsl:variable> 
