...
<link href="http://www.ibm.com/common/v16/css/cn/zh/screen-fonts.css" media="screen,projection" rel="stylesheet" title="www" type="text/css"/>
...
<!-- Overlays --> 
<!-- <#include "/inc/zh_CN/s-reserved-overlay-landing.ftl"> -->
    ...
    <xsl:choose>
        <xsl:when test=".//content-area-primary/@name = 'data' "> 
            <div id="ibm-navigation">
                <h2 class="ibm-access">内容导航</h2>
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/cn/data/">Information
                        Mgmt</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/data/newto/">新手入门</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/data/overview/">导航</a></li>
                    <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/cn/data/products/">产品</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/data/downloads/">下载</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/views/data/libraryview.jsp">文档库</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/data/training/trainingcertification.html">培训</a></li>
                    <!-- <li><a href="http://www.ibm.com/developerworks/data/">Information Mgmt (英文)</a></li> -->
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'lotus' "> 
            <div id="ibm-navigation">
                <h2 class="ibm-access">内容导航</h2>
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/cn/lotus/">Lotus</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/lotus/newto/">新手入门</a></li>
                    <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/cn/lotus/products/">产品</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/lotus/downloads/">下载</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/views/lotus/libraryview.jsp">文档库</a></li>
                    <!-- <li><a href="http://www.ibm.com/developerworks/lotus/">Lotus (英文)</a></li> -->
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'rational' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a
                        href="http://www.ibm.com/developerworks/cn/rational/">Rational</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/rational/newto/">新手入门</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/rational/overview/">导航</a></li>
                    <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/cn/rational/products/">产品</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/rational/downloads/">下载</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/views/rational/libraryview.jsp">文档库</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/rational/training/">培训</a></li>
                    <!-- <li><a href="http://www.ibm.com/developerworks/rational/">Rational (英文)</a></li> -->
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'tivoli' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/cn/tivoli/">Tivoli</a></li>
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'websphere' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    ...
                    <li><a href="http://www.ibm.com/developerworks/cn/websphere/newto/">新手入门</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/websphere/wsddoverview.html">导航</a></li>
                    <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/cn/websphere/products/">产品</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/websphere/downloads/">下载</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/views/websphere/libraryview.jsp">文档库</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/websphere/training/">培训</a></li>
                    <li><a href="http://www.ibm.com/developerworks/cn/websphere/support/index.html">技术支持</a></li>
                    <!-- <li><a href="http://www.ibm.com/developerworks/websphere/">WebSphere (英文)</a></li> -->
                </ul>
            </div>
        </xsl:when>
...
<!-- <#include "/inc/zh_CN/s-reserved-bottom-trial.ftl"> -->
<!-- <#include "/inc/zh_CN/s-reserved-bottom-scripts-trial.ftl"> -->
