...
<xsl:comment> LEFT_NAVIGATION_BEGIN </xsl:comment>
    <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
            <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/cn/">developerWorks</a></li>
        </ul>
</div>
...
<!-- <#include "/inc/zh_CN/s-reserved-bottom-landing.ftl"> -->
<!-- <#include "/inc/zh_CN/s-reserved-bottom-scripts-landing.ftl"> -->
