...
<!-- remove the Add to my dW interest overlay until that function is supported for local sites -->
...
<!-- <#include "/inc/en_VN/s-reserved-bottom-landing.ftl"> -->
<!-- <#include "/inc/en_VN/s-reserved-bottom-scripts-landing.ftl"> -->
