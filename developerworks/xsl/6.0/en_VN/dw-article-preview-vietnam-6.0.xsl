...
<p></p>
<p><strong>Tóm tắt:</strong>&nbsp; <xsl:apply-templates select=".">
...
<!-- <#if current_page_views?exists><#if (current_page_views == "0")><#elseif current_page_views == "1"><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>Activity:</strong>&nbsp; ${current_page_views} view<#else><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>Activity:</strong>&nbsp; ${current_page_views} views</#if></#if> -->
  <xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>Góp ý kiến:</strong> &nbsp; <span id="nCmts"><img alt="" src="//dw1.s81c.com/developerworks/i/circle-preloader.gif" height="12" width="50" /><img alt="" src="//dw1.s81c.com/i/c.gif" height="14" width="1" /></span>
...
dwc.instructCmt = 'Các trường có dấu hoa yhị (<span class="ibm-required">*</span>) là cần thiết để hoàn tất giao dịch này.';
dwc.cmt = 'Bình luận:';
dwc.btnPost = 'Đăng';
