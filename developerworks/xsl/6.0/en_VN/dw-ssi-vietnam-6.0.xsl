...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="xsl fo">
  ...
  <xsl:variable name="ssi-s-backlink-module">
    ...
    <p class="ibm-ind-link ibm-back-to-top ibm-no-print">
      <a class="ibm-anchor-up-link" href="#ibm-pcon">Về đầu trang</a> 
    </p>
  </xsl:variable>
<!-- s-backlink-rule.inc -->
...
<a class="fbox" href="#main"><strong>Về đầu trang</strong></a>
</td>
</tr>
</table>
</td>
...
<!--5.7 3/20 llk:  add link to english for local sites -->
...
document.write('<tr valign="top"><td width="8"><img src="]]></xsl:text><xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img src="]]></xsl:text>
  <xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/v14/icons/em.gif" height="16" width="16" vspace="3" alt="Gửi qua Email trang này" /></td><td width="122"><p><a class="smallplainlink" href="javascript:document.email.submit()"><strong>Gửi qua Email trang này </strong></a></p></td></tr>');
//-->
</script>]]></xsl:text>
...
<td width="122" class="small"><p><span class="ast">Không hiển thị được các lựa chọn của tài liệu cần JavaScript</span></p></td>
</tr>
</noscript>
</xsl:variable>
...
<!-- 5.0 7/28 tdc:  document.write statement now uses variable for paths -->
<!-- 5.6 10/24 llk: added cdata around the subdirectory path of print gif-->
<xsl:text disable-output-escaping="yes"><![CDATA[<script language="JavaScript" type="text/javascript">
<!--
document.write('<tr valign="top"><td width="8"><img src="]]></xsl:text><xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img alt="Đặt giấy in ở chế độ nằm ngang" height="16" src="]]></xsl:text>
<xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/v14/icons/printer.gif" width="16" vspace="3" /></td><td width="122"><p><strong><a class="smallplainlink" href="javascript:print()">In trang này</a></strong></p></td></tr>');
//-->
</script>
...
<tr>
<td class="left-nav-spacer"><a class="left-nav-overview" href="http://www.ibm.com/developerworks/vn/">&nbsp;</a></td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr>
<!-- 5.2 8/31/05 tdc:  Changed th to td (correcting old template generator error) -->
<td class="left-nav-overview" colspan="2"><a class="left-nav-overview" href="http://www.ibm.com/developerworks/vn/">developerWorks Việt Nam</a></td>
</tr>
</table>
</xsl:variable>
...
<!-- 5.4 03/06/06 jrw:  Added new code for new rating scale (DR #1517) -->
<table border="0" cellpadding="0" cellspacing="0" class="v14-gray-table-border" width="443">
<tr>
<td width="425">
<table cellspacing="0" cellpadding="0" border="0" width="100%">
<tr>
<td colspan="2"><p>Làm ơn giành chút thời gian điền vào mẫu này để chúng tôi phục vụ bạn được tốt hơn.</p></td>
</tr>
<tr valign="top">
...
<p><label for="Goal">Các thông tin này có đúng với mục đích của bạn?</label></p>
</td>
...
<!-- 5.10 0423 egd Updated to fix id and label accessibility errors -->
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td><input type="radio" name="goal" id="goal-yes" value="Yes" /><label for="goal-yes">Có</label></td>
<td><input type="radio" name="goal" id="goal-no" value="No" /><label for="goal-no">Không</label></td>
<td><input type="radio" name="goal" id="goal-undecided" value="Don't know" /><label for="goal-undecided">Không biết</label></td>
</tr>
</table>
</td>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Comments">Làm ơn góp ý cho chúng tôi để giúp cải thiện trang này:</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Rating">Các thông tin này có hữu dụng với bạn không?</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<!-- 5:10 llk - backed these out due to ratings app error : 5.9 08/28/09 tdc:  Removed dup. name and id values for Rating (DR 2540) -->
<tr>
...
<tr>
<td width="58" align="left"><span class="greytext">Không</span><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><span class="greytext">hữu dụng</span></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="61" align="left"><span class="greytext">Cực kỳ<xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>hữu dụng</span></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
<td colspan="2"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/submit.gif" border="0" width="120" height="21" alt="Gửi góp ý" /></td>
</tr>
<tr><td colspan="2"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
<tr>
<td colspan="3"><p>Làm ơn giành chút thời gian điền vào mẫu này để chúng tôi phục vụ bạn được tốt hơn.</p></td>
</tr>
<tr valign="top">
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
<td colspan="3"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/submit.gif" border="0" width="120" height="21" alt="Gửi góp ý" /></td>
</tr>
<tr><td colspan="3"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<!-- 5.2 10/26 tdc:  Changed class from v14-header-1-small to v14-header-2-small -->
<tr><td class="v14-header-2-small">Chấm điểm trang này</td></tr>
</table>
...
<td width="125"><p><a class="smallplainlink" href="#rate"><strong>Giúp chúng tôi cải thiện nội dung này</strong></a></p></td>
</tr>
</table>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<!-- 5.2 10/26 tdc:  Changed class from v14-header-1-small to v14-header-2-small -->
<tr><td class="v14-header-2-small">Chấm điểm bài học này</td></tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="v14-gray-table-border">
<tr>
<td width="150" class="no-padding">
...
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td>
<td><img src="{$newpath-ibm-local}www.ibm.com/i/v14/icons/d_bold.gif" height="16" width="16" border="0" vspace="3" alt=""/></td>
<td width="125"><p><a class="smallplainlink" href="rating.html"><strong>Giúp chúng tôi cải thiện nội dung này</strong></a></p></td>
</tr>
</table>
</td>
</tr>
...
<!-- 5.3 11/30/05 JPP/EGD:  Made site identifier hot to return to home page -->
<xsl:variable name="ssi-s-site-identifier">
<td width="192" class="no-print"><a href="{$developerworks-top-url}"><img src="{$newpath-dw-root-local}i/dw.gif" width="192" height="18" border="0" alt="developerWorks Việt Nam" /></a></td>
</xsl:variable>
