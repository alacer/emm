...
-->
  ...
  <!-- 12/13/2011 - llk - added top url for pdfs -->
    <xsl:variable name="developerworks-top-url-pdf">ibm.com/developerWorks/vn/</xsl:variable>
...
<!-- Maverick 6.0 R3 egd 01 20 10:  Updated top heading for xM release -->
  <xsl:variable name="developerworks-top-heading">developerWorks tiếng Việt</xsl:variable>
...
<!--  5.2 10/03 fjc: add training inc-->
  ...
  <xsl:variable name="knowledge-path-heading">Phát triển kỹ năng về chủ đề này</xsl:variable>
  <xsl:variable name="knowledge-path-text">Nội dung này nằm trong "đường dẫn đến kiến thức (knowledge path)" để bổ sung các kỹ năng của bạn. Xem</xsl:variable>
  <xsl:variable name="knowledge-path-text-multiple">Nội dung này nằm trong "đường dẫn đến kiến thức (knowledge path)" để bổ sung các kỹ năng của bạn. Xem:</xsl:variable>
...
<xsl:variable name="site_id">70</xsl:variable>
 ...
 <xsl:variable name="dcRights-v16"><xsl:text>&#169; Copyright&#160;</xsl:text>
  ...
  <!-- llk 12/13/2011 - added trademark url to localize pdf creation -->
    <xsl:variable name="pdfTrademarks-url">http://www.ibm.com/developerworks/vn/ibm/trademarks/</xsl:variable>
  <xsl:variable name="pdfTrademarks-url-printed">www.ibm.com/developerworks/vn/ibm/trademarks/</xsl:variable>
