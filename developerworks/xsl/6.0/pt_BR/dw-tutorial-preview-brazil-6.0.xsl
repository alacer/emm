...
<p></p>
    <p><strong>Resumo:</strong>&nbsp; <xsl:apply-templates select=".">
...
-->
    <xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>Comentários</strong> &nbsp; <span id="nCmts"><img alt="" src="//dw1.s81c.com/developerworks/i/circle-preloader.gif" height="12" width="50" /><img alt="" src="//dw1.s81c.com/i/c.gif" height="14" width="1" /></span>
...
<xsl:comment> INLINE_COMMENTS_START </xsl:comment>
    <p class="ibm-no-print"><span class="atitle"><a name="icomments">Comentários</a></span></p>
...
<xsl:comment> Comment_Script </xsl:comment>
    ...
    <script language="JavaScript" type="text/javascript">
        // <![CDATA[
dwc = {};
dwc.cmts = 'comentários';
dwc.signIn = 'Conectar';
dwc.addCmts = 'Incluir comentários';
dwc.addCmt = 'Incluir comentário';
dwc.viewOrAddCmts = 'Visualizar ou incluir comentários';
dwc.reportInapprCont = 'Relatar conteúdo inapropriado';
dwc.reportInapprContLink = 'http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1832';
dwc.postingCmt = 'Postar comentário';
dwc.noCmt = 'Nenhum comentário postado para esse artigo';
dwc.netwkErr = 'Há um problema na recuperação dos comentários. Atualize a página mais tarde.';
dwc.addACmt = 'Incluir um comentário';
dwc.instructCmt = 'O campo indicado com um asterisco (<span class="ibm-required">*</span>) é necessário para completar essa transação.';
dwc.cmt = 'Comentário:';
dwc.btnPost = 'Postar';
dwc.btnPostAnon = 'Postar anonimamente';
dwc.btnClrCmt = 'Limpar comentário';
dwc.btnCancel = 'Cancelar';
dwc.showRecent = 'Mostrar {1} comentários mais recentes'; // {1} is the count to be substituted
dwc.showNext = 'Mostrar próximos {1} comentários'; // {1} is the count to be substituted
dwc.showAllCmts = 'Mostrar todos os comentários';
dwc.enterCmt = 'Insira um comentário.';
dwc.loginErr = 'Seu status de login não pode ser verificado neste ponto. Tente novamente mais tarde.';
dwc.postErr = 'Seu comentário não pode ser postado neste momento. Tente novamente mais tarde.';
dwc.postBy = 'Enviado por <strong>{1}</strong> em {2}'; // {1} is the author to be substituted; {2} is the date
dwc.siteId = 80;
dwc.lang = 'pt_BR';
// ]]>
    </script>
