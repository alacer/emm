...
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCIBIBR" />  
  </xsl:when>
...
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCCLDBR" />
  </xsl:when>
<xsl:when test=".//content-area-primary/@name = 'industry' ">
<meta scheme="IBM_WTMCategory" name="IBM.WTMCategory" content="SOFDCINDBR" />
  </xsl:when>  
<xsl:otherwise>
  </xsl:otherwise>
</xsl:choose>
...
<link href="http://dw1.s81c.com/common/v16/css/br/pt/screen-fonts.css" media="screen,projection" rel="stylesheet" title="www" type="text/css"/>
...
<div class="kp-track">
   <p class="ibm-ind-link">
       <a class="ibm-password-link" href="#" onclick="showSignIn();return false;">  <strong>Acesse</strong></a> para salvar seu progresso <!-- 07/13/11 Removed checkmark per Ami -->     
      (<a class="kp-learn-text" href="#learnMore" onclick="ibmCommon.Overlays.show('learnMore', this);return false;">Saiba mais</a>)
   </p>
</div>
<!-- Alternate signed in -->
<!-- 
<div class="kp-track2">
   <p class="ibm-ind-link kp-track3">
      <strong>Saving your progress</strong><img class="check-top" src="//www.ibm.com/i/v16/icons/confirm.gif" alt="Marcador de verificação em verde" />
...
<div class="dw-kp-rate">
    <br />
    <br />
      <h2 class="kp-rate-head">Classifique este conteúdo</h2><span id="interactiveRatingUI"></span>
    <br />
    <br />
</div>
...
<h2 class="kp-feedback-head">Deixe seu comentário</h2>
...
<div class="kp-feedback-signin-msg">   
   <img src="//dw1.s81c.com/i/v16/icons/key.gif" class="kp-key-bottom" border="0" alt="Acesse"/>
   <span>
      <a href="#" onclick="showSignIn();return false;"><strong class="kp-vert-align-middle">Acesse</strong></a>  to give us your feedback
   </span>
</div>
...
<p><span class="kp-form-step-head"><strong>1.</strong>&nbsp;</span><strong>Tem certeza que deseja sair deste guia de capacitação?</strong><br />
   <span class="ibm-input-group kp-form-entry">
      <input id="yes" name="tasks" type="radio" value="yes"/><label for="yes">Sim</label>&nbsp;&nbsp;&nbsp;
     <input id="no" name="tasks" type="radio" value="no"/><label for="no">Não</label>&nbsp;&nbsp;&nbsp;
    </span>
</p>
   
<p><span class="kp-form-step-head"><strong>2.</strong>&nbsp;</span><strong>Quanto você aprendeu?</strong><br />  
   <span class="ibm-input-group kp-form-entry">
     <input id="alot" name="learned" type="radio" value="alot" /><label for="alot">Muito</label>&nbsp;&nbsp;&nbsp;
     <input id="some" name="learned" type="radio" value="some" /><label for="some">Alguma coisa</label>&nbsp;&nbsp;&nbsp;
     <input id="alittle" name="learned" type="radio" value="alittle" /><label for="alittle">Pouco</label>&nbsp;&nbsp;&nbsp;
      <input id="nothing" name="learned" type="radio" value="nothing" /><label for="nothing">Nada</label>
</span>
</p>

<p class="dw-kp-form-tell-us"><span class="kp-form-step-head"><strong>3.</strong>&nbsp;</span><strong>Conte-nos mais</strong>       
              <ul class="ibm-bullet-list ibm-no-links kp-form-entry kp-form-list">
                <li>De que você gostou ou não?</li>
                <li>Em que podemos melhorar?</li>
                 </ul>
                     <span class="ibm-access"><label for="feedback">Deixe seus comentários abaixo</label></span>
...
<!-- <p id="dw-kp-nonsubmit"><img src="http://dw1.s81c.com/developerworks/i/submit-gry-br.gif" alt="Botão de envio desabilitado" /></p> -->
...
<h2>Sobre este guia de capacitação</h2>
...
<script language="JavaScript" type="text/javascript">
  ...
  dwrating = {};
  dwrating.averageRatingText = 'A classificação média é de {1} estrela';
  dwrating.averageRatingPluralText = 'A classificação média é de {1} estrelas';
  dwrating.wordRatingText = 'classificação';
  dwrating.wordRatingsText = 'classificações';
  dwrating.errorRatingText = 'Falha no envio. Tente novamente.';
  dwrating.unavailRatingText = 'As classificações não estão disponíveis';
  dwrating.saving = 'Processando…'; 
  dwrating.ratingTexts =  ["1 de 5 estrelas (odiei)", 
                          "2 de 5 estrelas (não gostei)", 
                          "3 de 5 estrelas (regular)", 
                          "4 de 5 estrelas (gostei) ", 
                          "5 de 5 estrelas (gostei muito)"];
  dwrating.selectedRatingTexts = ["Não há estrelas selecionadas", 
                          "1 estrela selecionada", 
                          "2 estrelas selecionadas", 
                          "3 estrelas selecionadas", 
                          "4 estrelas selecionadas", 
                          "5 estrelas selecionadas"]; 
  dwrating.youRatedText1 = 'Você classificou esse item com {1} estrela. Média atual : {2} estrela.';
  dwrating.youRatedText2 = 'Você classificou esse item com {1} estrela. Média atual : {2} estrelas.';
  dwrating.youRatedText3 = 'Você classificou esse item com {1} estrelas. Média atual : {2} estrelas.';  
...
'<div id="dw-interest-remove"><img src="http://dw1.s81c.com/i/v16/icons/confirm.gif" alt="Marcador de verificação em verde" /><a id="intDeselectBtn" class="ibm-external-link" href="">Added to My dW interests</a> (<a class="dw-interest" href="https://www.ibm.com/developerworks/mydeveloperworks/profiles/html/myProfileView.do?lang=en">Edit</a>)</div>'
);
   // ]]>
</script>
