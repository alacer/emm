...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="xsl fo">
  ...
  <xsl:variable name="journal-link-intro">Este conteúdo é parte do</xsl:variable>
  ...
  <xsl:variable name="pdf-common">A4 e Carta</xsl:variable>
...
-->
  ...
  <!-- 12/13/2011 - llk - added top url for pdfs -->
    <xsl:variable name="developerworks-top-url-pdf">ibm.com/developerWorks/br/</xsl:variable>
  ...
  <xsl:variable name="developerworks-top-heading">developerWorks Brasil</xsl:variable>
 ...
 <!-- 6.0 Maverick beta egd 06/12/08: Updated for MAVERICK to include zone top URLs -->
  ...
  <xsl:variable name="ibmi-top-url">http://www.ibm.com/developerworks/systems/ibmi/</xsl:variable> 
   ...
   <xsl:variable name="mobile-top-url">http://www.ibm.com/developerworks/br/mobile/</xsl:variable>
   ...
   <xsl:variable
       name="webservices-top-url">http://www.ibm.com/developerworks/br/webservices/</xsl:variable>
...
<!--  some left nav inc-->
  ...
  <!-- 6.0 jpp 10/30/08 : Added variable to cover content area in the extended content area week -->
  <xsl:variable name="contentarea-ui-name-community">Comunidade</xsl:variable>
  <!-- 6.0 jpp 10/30/08 : Added variable to cover content area in the extended content area week -->
  ...
  <xsl:variable name="contentarea-ui-name-mobile">Desenvolvimento móvel</xsl:variable>
  ...
  <xsl:variable name="contentarea-ui-name-in">Segmentos de mercado</xsl:variable>
 ...
 <!-- 01/15/13 jmh: change variable value to Tivoli (service management)  -->
  ...
  <xsl:variable name="techlibview-mobile">http://www.ibm.com/developerworks/br/views/mobile/libraryview.jsp</xsl:variable>
  ...
  <xsl:variable name="kp-unchecked-checkmark">Item completo - Clique aqui para marcar como incompleto</xsl:variable>
  <xsl:variable name="kp-checked-checkmark">Item completo - Clique aqui para marcar como incompleto</xsl:variable>
 ...
 //-->
  ...
  <xsl:variable name="dcRights-v16"><xsl:text>&#169; Copyright&#160;</xsl:text>
    ...
    </xsl:if> <xsl:text>. Todos os direitos reservados.</xsl:text></xsl:variable>
  ...
  <!-- llk 12/13/2011 - added trademark url to localize pdf creation -->
    <xsl:variable name="pdfTrademarks-url">http://www.ibm.com/developerworks/br/ibm/trademarks/</xsl:variable>
<xsl:variable name="pdfTrademarks-url-printed">www.ibm.com/developerworks/br/ibm/trademarks/</xsl:variable>
...
<!-- End Maverick Landing Page variables -->
  ...
  <xsl:variable name="errorTableSummaryAttribute">Esta tabela contém uma mensagem de erro.</xsl:variable>   </xsl:stylesheet>