...
<!--    =============================================== -->
	<xsl:template match="dw-document/dw-tutorial">
		...
		<!--  5.7 2007-03-22 ibs - DR 2257 to use dw-xml-file-name parameter.  -->
		...
		<!-- to create one single PDF to fit A4 and Ltr printers comment this code and uncomment out the below -->	
		<!--  5.7 2007-03-22 ibs - DR 2257 to use dw-xml-file-name parameter.  -->	
		<!--  5.11 11.10.08 ibs/ddh - DR 2941: Fix PDF generation if no pdf element
	                  asks for them and DR 2857:  Remove a4 and letter code from the schemas and stylesheets.  -->
