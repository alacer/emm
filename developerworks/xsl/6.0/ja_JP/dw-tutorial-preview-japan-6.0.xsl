...
<p></p>
    <p><strong>概要：</strong>&nbsp; <xsl:apply-templates select=".">
...
<!-- <p class="ibm-no-print"><div id="dw-tag-this" class="ibm-no-print"><a
    class="ibm-external-link" onclick="jQuery.launchTagThisWindow(); return false;"
    href="#">Tag this!</a></div><div id="interestShow" class="ibm-no-print"></div></p>
    -->
</div>
...
-->
    <xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text><strong>お気軽にご意見・ご感想をお寄せください</strong> &nbsp; <span id="nCmts"><img alt="" src="//dw1.s81c.com/developerworks/i/circle-preloader.gif" height="12" width="50" /><img alt="" src="//dw1.s81c.com/i/c.gif" height="14" width="1" /></span>
...
<xsl:comment> INLINE_COMMENTS_START </xsl:comment>
    <p class="ibm-no-print"><span class="atitle"><a name="icomments">お気軽にご意見・ご感想をお寄せください</a></span></p>
...
dwc.addCmts = 'コメントを追加';
dwc.addCmt = 'コメントを追加';
dwc.viewOrAddCmts = 'コメントの閲覧または追加';
dwc.reportInapprCont = '不適切なコンテンツの報告';
dwc.reportInapprContLink = 'http://www.ibm.com/developerworks/forums/forum.jspa?forumID=1834';
dwc.postingCmt = 'コメントを投稿';
dwc.noCmt = 'この記事にはコメントがありません';
dwc.netwkErr = 'コメントの取得に問題があります。後ほどページをリフレッシュしてください。';
dwc.addACmt = 'コメントを追加';
dwc.instructCmt = 'アスタリスク(<span class="ibm-required">*</span>) のあるフィールドは、このトランザクションを完了するために必須です。';
dwc.cmt = 'コメント:';
dwc.btnPost = '投稿';
dwc.btnPostAnon = '匿名投稿';
dwc.btnClrCmt = 'コメントの消去';
dwc.btnCancel = 'キャンセル';
dwc.showRecent = '最新の{1} コメントの表示'; // {1} is the count to be substituted
dwc.showNext = '次の{1}コメントの表示'; // {1} is the count to be substituted
dwc.showAllCmts = '全てのコメントの表示';
dwc.enterCmt = 'コメントを入力してください';
dwc.loginErr = 'ログイン状態をこの時点で確認することはできません。後ほどやり直してください。';
dwc.postErr = 'お客様のコメントは、この時点で投稿することはできません。後でやり直してください。';
dwc.postBy = '<strong>{1}</strong> によって {2} に投稿されました'; // {1} is the author to be substituted; {2} is the date
dwc.siteId = 60;
dwc.lang = 'ja_JP';
// ]]>
    </script>
...
<!--<#include "/inc/s-reserved-bottom1.ftl">-->
