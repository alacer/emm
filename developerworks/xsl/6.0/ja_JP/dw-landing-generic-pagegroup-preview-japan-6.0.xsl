...
<xsl:template name="dw-landing-generic-pagegroup-preview">
    ...
    <xsl:choose>
        <xsl:when test="element-available('redirect:write' )">
		  ...
		  <xsl:value-of select="." />
                            ...
                            <xsl:otherwise>
                                <xsl:call-template name="lgp-substring-after-last">
                    ...
                    <redirect:write select="string($preview-page-name)">
                        <xsl:for-each select="$this-content">
                            <xsl:call-template name="dw-landing-generic-pagegroup-preview-one-page">
...
<xsl:template name="lgp-substring-after-last">
...
<xsl:template name="dw-landing-generic-pagegroup-preview-one-page">
...
<xsl:comment> LEFT_NAVIGATION_BEGIN </xsl:comment>
  <div id="ibm-navigation">
    ...
    <ul id="ibm-primary-links">
      <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/jp/">developerWorks</a></li>
    </ul>
</div>
...
<!-- <#include "/inc/ja_JP/s-reserved-bottom-landing.ftl"> -->
<!-- <#include "/inc/ja_JP/s-reserved-bottom-scripts-landing.ftl"> -->
