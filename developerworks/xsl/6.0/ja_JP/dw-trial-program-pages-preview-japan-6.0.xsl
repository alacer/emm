...
<xsl:comment> MAIN_COLUMN_CONTENT_END </xsl:comment>
  <p><a href="http://www.ibm.com/developerworks/jp/ibm/trademarks/">商標</a> &nbsp;|&nbsp; <a href="http://www.ibm.com/developerworks/jp/mydw_terms/">My developerWorks ご利用条件</a></p>

<!-- Overlays --> 
<!-- <#include "/inc/ja_JP/s-reserved-overlay-landing.ftl"> -->
  ...
  <xsl:choose>
    <xsl:when test=".//content-area-primary/@name = 'data' "> 
      <div id="ibm-navigation">
        <h2 class="ibm-access">コンテンツ・ナビゲーション</h2>
        
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/jp/data/">Information
            Mgmt</a></li>
          
          <li><a href="http://www.ibm.com/developerworks/jp/data/overview.html">利用ガイド</a></li>
          <li><a href="http://www.ibm.com/developerworks/jp/views/data/libraryview.jsp">技術文書一覧</a></li>
        </ul>
      </div>
    </xsl:when>
    <xsl:when test=".//content-area-primary/@name = 'lotus' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/jp/lotus/">Lotus</a></li>
          <li><a href="http://www.ibm.com/developerworks/jp/lotus/overview.html">利用ガイド</a></li>
          <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/jp/lotus/products/">製品別技術情報</a></li>
          <li><a href="http://www.ibm.com/developerworks/jp/views/lotus/libraryview.jsp">技術文書一覧</a></li>
        </ul>
      ...
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a
            href="http://www.ibm.com/developerworks/jp/rational/">Rational</a></li>
          <li><a href="http://www.ibm.com/developerworks/jp/views/rational/libraryview.jsp">技術文書一覧</a></li>
        </ul>
    ...
    <xsl:when test=".//content-area-primary/@name = 'tivoli' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/jp/tivoli/">Tivoli</a></li>
          <li><a class="ibm-is-active" href="/developerworks/jp/tivoli/products/products_index.html">製品別技術情報</a></li>    
          <li><a href="http://www.ibm.com/developerworks/jp/views/tivoli/libraryview.jsp">技術文書一覧</a></li>
        </ul>
    ...
    <xsl:when test=".//content-area-primary/@name = 'websphere' "> 
      <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
          <li id="ibm-overview"><a
            href="http://www.ibm.com/developerworks/jp/websphere/">WebSphere</a></li>
          <li><a class="ibm-is-active" href="http://www.ibm.com/developerworks/jp/websphere/guide.html">利用ガイド</a></li>
          <li><a href="http://www.ibm.com/developerworks/jp/views/websphere/libraryview.jsp">技術文書一覧</a></li>
        </ul>
      </div>
    </xsl:when>
...
<!-- <#include "/inc/ja_JP/s-reserved-bottom-trial.ftl"> -->
<!-- <#include "/inc/ja_JP/s-reserved-bottom-scripts-trial.ftl"> -->
