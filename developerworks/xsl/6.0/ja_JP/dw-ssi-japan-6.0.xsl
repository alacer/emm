...
<!-- 6.0 Maverick beta egd 06/16/08:  Updated code for back-to-top link -->
  ...
  <xsl:variable name="ssi-s-backlink-module">
    <p class="ibm-ind-link ibm-back-to-top ibm-no-print">
      <a class="ibm-anchor-up-link" href="#ibm-pcon">上に戻る</a> 
    </p>
  </xsl:variable>
<!-- s-backlink-rule.inc -->
...
<td align="right" valign="top">
<a class="fbox" href="#main"><strong>上に戻る</strong></a>
</td>
</tr>
</table>
</td>
...
<tr valign="top"><td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img src="{$newpath-ibm-local}www.ibm.com/i/v14/icons/fw_bold.gif" height="16" width="16" vspace="3" alt="原文はこちら
" /></td><td width="122"><p><a class="smallplainlink" href="{$original_version_url}" onmouseover="linkQueryAppend(this)"><strong> 原文はこちら</strong></a></p></td></tr>
                    </xsl:otherwise>
</xsl:choose>
</xsl:if>
</xsl:variable>
...
<xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/v14/icons/em.gif" height="16" width="16" vspace="3" alt="ページをe-メールで送信"  /></td><td width="122"><p><a class="smallplainlink" href="javascript:void newWindow()"><strong>ページをe-メールで送信</strong></a></p></td></tr>');
//-->
</script>]]></xsl:text>
...
<td width="122" class="small"><p><span class="ast">JavaScript を要するドキュメントオプションは表示されません</span></p></td>
</tr>
</noscript>
</xsl:variable>
...
<xsl:text disable-output-escaping="yes"><![CDATA[<script language="JavaScript" type="text/javascript">
<!--
document.write('<tr valign="top"><td width="8"><img src="]]></xsl:text><xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td><td width="16"><img alt="プリンターを横向き印刷にセットしてください" height="16" src="]]></xsl:text>
<xsl:value-of select="$newpath-ibm-local"/><xsl:text disable-output-escaping="yes"><![CDATA[www.ibm.com/i/v14/icons/printer.gif" width="16" vspace="3" /></td><td width="122"><p><strong><a class="smallplainlink" href="javascript:print()">ページを印刷する</a></strong></p></td></tr>');
//-->
</script>
...
<tr>
<td class="left-nav-spacer"><a class="left-nav-overview" href="http://www.ibm.com/developerworks/jp/">&nbsp;</a></td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr>
<td class="left-nav-overview" colspan="2"><a class="left-nav-overview" href="http://www.ibm.com/developerworks/jp/">developerWorks Japan</a></td>
</tr>
</table>
</xsl:variable>
...
<tr>
<td colspan="2"><p>サイト改善のため、ご意見をお寄せください。こちらのフォームからお願いいたします。</p></td>
</tr>
<tr valign="top">
...
<p><label for="Goal">この情報はお客様が目的を達成するうえで役に立ちましたか？</label></p>
</td>
...
<tr>
<td><input type="radio" name="goal" id="goal-yes" value="Yes" /><label for="goal-yes">はい</label></td>
<td><input type="radio" name="goal" id="goal-no" value="No" /><label for="goal-no">いいえ</label></td>
<td><input type="radio" name="goal" id="goal-undecided" value="Don't know" /><label for="goal-undecided">わからない</label></td>
</tr>
</table>
</td>
</tr>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Comments">お気軽にご意見・ご感想をお寄せください。</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr valign="top">
<td width="132"><img alt="" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="132"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<p><label for="Rating">この記事は役に立ちましたか？</label></p>
</td>
<td width="293"><img alt="" height="6" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="293"/><xsl:text disable-output-escaping="yes"><![CDATA[<br />]]></xsl:text>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr>
<td width="58" align="left"><span class="greytext">不充分・不完全である</span></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="58" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="61" align="left"><span class="greytext">大変素晴らしい</span></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
<td colspan="2"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/jp/ja/submit.gif" border="0" width="120" height="21" alt="送信する" /></td>
</tr>
<tr><td colspan="2"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
<tr>
<td colspan="3"><p>サイト改善のため、ご意見をお寄せください。こちらのフォームからお願いいたします。</p></td>
</tr>
<tr valign="top">
...
<tr>
<td width="60" align="left"><span class="greytext">不充分・不完全である</span></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="60" align="left"><img alt="" width="1" height="1" src="{$newpath-ibm-local}www.ibm.com/i/c.gif" /></td>
<td width="63" align="left"><span class="greytext">大変素晴らしい</span></td>
</tr></table>
</td>
<td width="100%">&nbsp;</td>
</tr>
...
<tr>
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt="" /></td>
<td colspan="3"><input type="image" src="{$newpath-ibm-local}www.ibm.com/i/v14/buttons/jp/ja/submit.gif" border="0" width="120" height="21" alt="Submit" /></td>
</tr>
<tr><td colspan="3"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="8" alt="" /></td></tr>
</table>
</xsl:variable>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr><td class="v14-header-2-small">記事の評価</td></tr>
</table>
...
<td width="125"><p><a class="smallplainlink" href="#rate"><strong>ご意見ご要望をお寄せ下さい</strong></a></p></td>
</tr>
</table>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="150">
<tr><td class="v14-header-2-small">この記事を評価する</td></tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="v14-gray-table-border">
<tr>
<td width="150" class="no-padding">
...
<td width="8"><img src="{$newpath-ibm-local}www.ibm.com/i/c.gif" width="8" height="1" alt=""/></td>
<td><img src="{$newpath-ibm-local}www.ibm.com/i/v14/icons/d_bold.gif" height="16" width="16" border="0" vspace="3" alt=""/></td>
<td width="125"><p><a class="smallplainlink" href="rating.html"><strong>ご意見ご要望をお寄せ下さい</strong></a></p></td>
</tr>
</table>
</td>
</tr>
