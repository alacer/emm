...
<#elseif200 dwrequest.zone == "automonic">
<xsl:apply-templates select=".">
<xsl:with-param name="template">breadcrumb</xsl:with-param>
<xsl:with-param name="transform-zone">autonomic</xsl:with-param>
</xsl:apply-templates>
...
<#elseif200 dwrequest.zone == "grid">
<xsl:apply-templates select=".">
<xsl:with-param name="template">breadcrumb</xsl:with-param>
<xsl:with-param name="transform-zone">grid</xsl:with-param>
</xsl:apply-templates>
...
<xsl:comment> INLINE_COMMENTS_START </xsl:comment>
  <p class="ibm-no-print"><span class="atitle"><a name="icomments">コメント</a></span></p>
