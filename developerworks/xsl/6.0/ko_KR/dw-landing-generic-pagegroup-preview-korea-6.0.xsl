...
<xsl:comment> LEFT_NAVIGATION_BEGIN </xsl:comment>
    <div id="ibm-navigation">
        ...
        <ul id="ibm-primary-links">
            <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/kr/">developerWorks</a></li>
        </ul>
</div>
<!-- </xsl:when> -->
<!-- <xsl:otherwise/> -->
...
<!-- <#include "/inc/ko_KR/s-reserved-bottom-landing.ftl"> -->
<!-- <#include "/inc/ko_KR/s-reserved-bottom-scripts-landing.ftl"> -->
