...
<!-- Overlays --> 
<!-- <#include "/inc/ko_KR/s-reserved-overlay-landing.ftl"> -->
    ...
    <xsl:choose>
        <xsl:when test=".//content-area-primary/@name = 'data' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/kr/data/">Information
                        Mgmt</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/data/newto/">Information Mgmt 입문</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/views/data/libraryview.jsp">기술자료 목록</a></li>
                    <li><a href="http://www.ibm.com/developerworks/forums/dw_krdb2forums.jspa">포럼</a></li>
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'lotus' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/kr/lotus/">Lotus</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/lotus/newto/">Lotus 입문</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/views/lotus/libraryview.jsp">기술자료 목록</a></li>
                    <li><a href="http://www.ibm.com/developerworks/forums/dw_krlsforums.jspa">포럼</a></li>
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'rational' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a
                        href="http://www.ibm.com/developerworks/kr/rational/">Rational</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/rational/newto/">Rational 입문</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/views/rational/libraryview.jsp">기술자료 목록</a></li>
                    <li><a href="http://www.ibm.com/developerworks/forums/dw_krrforums.jspa">포럼</a></li>
                </ul>
            </div>
        </xsl:when>
        <xsl:when test=".//content-area-primary/@name = 'tivoli' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a href="http://www.ibm.com/developerworks/kr/tivoli/">Tivoli</a></li>
                    
                    <li><a href="http://www.ibm.com/developerworks/kr/tivoli/newto/">Tivoli 입문</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/views/tivoli/libraryview.jsp">기술자료 목록</a></li>
                    <li><a href="http://www.ibm.com/developerworks/forums/dw_krtvforums.jspa">포럼</a></li>
                </ul>
        ...
        <xsl:when test=".//content-area-primary/@name = 'websphere' "> 
            <div id="ibm-navigation">
                ...
                <ul id="ibm-primary-links">
                    <li id="ibm-overview"><a
                        href="http://www.ibm.com/developerworks/kr/websphere/">WebSphere</a></li> 
                    <li><a href="http://www.ibm.com/developerworks/kr/websphere/newto/">WebSphere 입문</a></li>
                    <li><a href="http://www.ibm.com/developerworks/kr/views/websphere/libraryview.jsp">기술자료 목록</a></li>
                    <li><a href="http://www.ibm.com/developerworks/forums/dw_krwbsforums.jspa">포럼</a></li>
                </ul>
            </div>
        </xsl:when>
...
<!-- <#include "/inc/ko_KR/s-reserved-bottom-trial.ftl"> -->
<!-- <#include "/inc/ko_KR/s-reserved-bottom-scripts-trial.ftl"> -->
