...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
 <xsl:output method="xml" indent="no" omit-xml-declaration="yes" encoding="UTF-8"/>
  ...
  <!-- Call main xsl file and locale-specific xsl files --> 
    ...
    <xsl:include href="dw-translated-text-korea-6.0.xsl" />
  <!-- IBS 2012-02-06 Moved preview file includes to dw-document-html-sitename-6.0.xsl -->
  <xsl:include href="dw-landing-product-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-landing-generic-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-tutorial-preview-korea-6.0.xsl"/>  
  ...
  <xsl:include href="dw-article-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-sidefile-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-landing-generic-pagegroup-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-trial-program-pages-preview-korea-6.0.xsl"/>
  <xsl:include href="dw-knowledge-path-preview-korea-6.0.xsl"/>
...
<xsl:include href="dw-summary-preview-korea-6.0.xsl"/>
</xsl:stylesheet>
