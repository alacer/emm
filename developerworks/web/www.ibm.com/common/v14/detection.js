if((navigator.appName == "Microsoft Internet Explorer") && (parseInt(navigator.appVersion) >= 4 ) && (navigator.platform == "Win32") && (navigator.userAgent.indexOf(" Opera ") == -1) && (navigator.userAgent.indexOf("Opera/") == -1)){
	...
	document.write('<link rel="stylesheet" media="screen" href="http://www.ibm.com/common/v14/ie2_screen.css" type="text/css"/>');
	}
	else{
	document.write('<link rel="stylesheet" media="screen" href="http://www.ibm.com/common/v14/ie1_screen.css" type="text/css"/>');
	}
}
